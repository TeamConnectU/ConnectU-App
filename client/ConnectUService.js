angular.module('connectUApp')
  ...
  var user1 = {
    ...
    linkedin_url: 'https://www.linkedin.com/in/oliver-brummel-14a150a0',
  ...
  var user2 = {
    ...
    current_workplace: 'Prime Academy',
    linkedin_url: 'https://www.linkedin.com/in/suzannaaltman',
    focus: 'Software Developing',
  ...
  var user3 = {
    ...
    current_workplace: 'Prime Academy',
    linkedin_url: 'https://www.linkedin.com/in/erika-klein-137a60119',
    focus: 'Software Developing',
  ...
  var user4 = {
    ...
    college: 'MIT',
    current_workplace: 'Prime Academy',
    linkedin_url: 'https://www.linkedin.com/in/max-wanderman-088bb874',
    focus: 'Software Developing',
